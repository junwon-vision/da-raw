...
def build_strong_augmentation(cfg, is_train):
    ...
    # ADD Color jittering: brightness, contrast
    if is_train:
        augmentation.append(
            T.RandomBrightness(0.5,1.5)
        )
        augmentation.append(
            T.RandomContrast(0.3,1.8)
        )
        # augmentation.append(
        #     T.RandomApply(T.GaussianBlur(sigma=[0.1, 2.0]),prob=0.5)
        # )
    # 
    return augmentation


build_strong_transform_gen = build_strong_augmentation
